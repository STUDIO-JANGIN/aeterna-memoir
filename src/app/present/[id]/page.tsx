...
export default function PresentIdRedirectPage({ params }: PageProps) {
  ...
  if (status === "loading") {
    return (
      <div className="min-h-dvh flex items-center justify-center bg-[#050712] text-white font-sans text-sm text-gray-500">
  ...
  if (status === "not-found") {
    return (
      <div className="min-h-dvh flex flex-col items-center justify-center bg-[#050712] text-white font-serif px-6 text-center">
