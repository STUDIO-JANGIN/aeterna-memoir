...
export default function EventTributePage() {
  ...
  if (loading) {
    return (
      <div className="min-h-dvh flex items-center justify-center bg-[var(--aeterna-charcoal)] font-serif text-xs tracking-[0.35em] uppercase text-[var(--aeterna-gold-muted)]">
  ...
  if (!eventId || !event) {
    return (
      <div className="min-h-dvh flex flex-col items-center justify-center bg-[var(--aeterna-charcoal)] font-serif px-12 text-center text-white">
  ...
  return (
    <div className="min-h-dvh bg-[var(--aeterna-charcoal)] text-white font-serif pb-32 overflow-hidden relative">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#030303]/60 backdrop-blur-sm p-4">
          <div className="bg-white rounded-[2rem] max-w-sm w-full p-8 shadow-2xl border border-[#E4D7C7]">
            ...
            <p className="font-sans text-sm text-gray-600 mb-6">
              If you choose to add a voluntary tip to support Aeterna, we’ll then open the family’s link.
            </p>
