...
import { formatDateTime, formatLongDate } from "@/lib/formatDate"
...
export default function ArchivePage() {
  ...
  if (loading) {
    return (
      <div className="min-h-dvh flex items-center justify-center bg-[var(--aeterna-charcoal)] font-serif text-sm tracking-[0.2em] uppercase text-[var(--aeterna-gold-muted)]">
        Preparing archive…
      </div>
    )
  }
  ...
  return (
    <div className="min-h-dvh bg-[var(--aeterna-charcoal-muted)] text-[#222] flex items-center justify-center py-12 px-4 print:bg-white">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
            ...
            <div className="text-right font-sans text-[10px] leading-relaxed text-gray-500">
              ...
              <p className="mt-3 uppercase tracking-[0.24em]">
                Archived on {formatLongDate(new Date())}
              </p>
            </div>
          </div>
        </header>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 items-start">
                  ...
                  <div className="sm:col-span-1 space-y-3">
                    ...
                    <p className="font-sans text-[10px] tracking-[0.22em] uppercase text-gray-500">
                      {memories[0].created_at ? formatDateTime(memories[0].created_at) : ""}
                    </p>
                  </div>
                </div>
              )}
                  ...
                  >
                    ...
                    <div className="px-4 py-4 flex-1 flex flex-col gap-3">
                      ...
                      <p className="mt-auto font-sans text-[10px] tracking-[0.2em] uppercase text-gray-400">
                        {mem.created_at ? formatLongDate(mem.created_at) : ""}
                      </p>
                    </div>
                  </article>
                ))}
