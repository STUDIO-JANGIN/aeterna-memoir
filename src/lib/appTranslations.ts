...
const KO_PATCH: DeepPartial<AppStrings> = {
  ...
  createWizard: {
    ...
    whoHonoringSubtitle: "소중한 분을 위한 고요한 공간.",
    honorPerson: "소중한 사람",
    honorPet: "함께한 동반자 (반려동물)",
    step1Title: "이름",
