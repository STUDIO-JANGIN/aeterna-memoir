...
export function Navbar({ children, end }: NavbarProps) {
  return (
    <header className="pointer-events-auto fixed top-0 left-0 right-0 z-[50] grid grid-cols-[1fr_auto_1fr] items-center border-b-[0.5px] border-[rgba(255,255,255,0.1)] bg-[rgba(3,3,3,0.92)] px-5 py-5 backdrop-blur-[20px] md:px-10">
